            ...
            <HStack as='header' justify='center' bg='#495E57'>
                <Grid templateColumns={{ base: '1fr', md: '1fr 1fr' }} gap='20px' w='60%' pt='40px'>
                    <GridItem
                        ...
                        <br />
                        <br />
                        <Button aria-label="On Click" colorScheme='yellow' color='#333333' fontSize='18px' size='lg' borderRadius='16px' marginBottom={5}><Link to='/booking'>Reserve a Table</Link></Button>
                    </GridItem>
